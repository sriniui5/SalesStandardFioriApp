sap.ui.define([
		...
		return BaseObject.extend("finalapp.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias finalapp.model.ListSelector
			 */
			 ...
			 * @return {finalapp.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
