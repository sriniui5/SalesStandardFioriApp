...
sap.ui.define([
		...
		return BaseController.extend("finalapp.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("finalapp.view.ViewSettingsDialog", this);
