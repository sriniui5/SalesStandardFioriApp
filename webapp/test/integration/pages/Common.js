sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("finalapp/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("finalapp.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["finalapp/localService/mockserver"], function (mockserver) {
